...
public class QSPageActivity extends ActivityGroup {
    ...
    private void createView(){
        //create xiyi view
        Intent xiyiIntent = new Intent(QSPageActivity.this,WaitingActivity.class);
        ...
        //create order view
        Intent orderIntent = new Intent(QSPageActivity.this,OrderActivity.class);
        ...
        //create myself view
        Intent myIntent = new Intent(QSPageActivity.this,MyselfActivity.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (keyCode == KeyEvent.KEYCODE_BACK) {
                Builder builder = new Builder(QSPageActivity.this);
                builder.setTitle("提示");
