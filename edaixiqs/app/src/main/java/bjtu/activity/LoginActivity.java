...
public class LoginActivity extends AppCompatActivity {
    ...
    public CourierController courierController = new CourierController();
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            if("qs".equals(data.getString("userRole"))){
        ...
        public void onClick(View v) {
            ...
            Runnable loginNetWork = new Runnable() {
                ...
                public void run() {
                    ...
                    courier = courierController.login(phone,password);
                    Bundle data = new Bundle();
                    data.putString("userRole",courier.getRole());
                    data.putInt("userID",courier.getId());
                    msg.setData(data);
